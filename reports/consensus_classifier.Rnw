...
%\begin{figure}[H]
<<consensus_rf_contingency_plots, fig.width=10, fig.height=11, out.width="0.7\\textwidth", eval=FALSE>>=
...
<<survival_plots, fig.width=12, fig.height=6>>=
...
for(data.subset in c("all", "concordant")) {
  #par(mar=c(5.1, 5, 4.1, 2.1))
    ...
    for(classifier in c("Gene Pairs RF")) {
...
legend("bottomright", paste0(c("Helland", "Verhaak", "Konecny", "Consensus Gene-Pairs RF"), paste(", AUC:",sprintf("%.3f", aucs))), lwd=2, col=roc.colors, bty="n")
