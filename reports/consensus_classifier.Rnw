...
<<ROC curve>>=
plot(ROCR::performance(ROCR::prediction(pooled.subtypes$Helland.margins, pooled.subtypes$concordant), "tpr", "fpr"), col=2)
plot(ROCR::performance(ROCR::prediction(pooled.subtypes$Verhaak.margins, pooled.subtypes$concordant), "tpr", "fpr"), col=3, add=TRUE)
plot(ROCR::performance(ROCR::prediction(pooled.subtypes$Konecny.margins, pooled.subtypes$concordant), "tpr", "fpr"), col=4, add=TRUE)
plot(ROCR::performance(ROCR::prediction(pooled.subtypes$Consensus.rf.margin, pooled.subtypes$concordant), "tpr", "fpr"), col=1, add=TRUE)
plot(ROCR::performance(ROCR::prediction(pooled.subtypes$Consensus.rf.maxprob, pooled.subtypes$concordant), "tpr", "fpr"), col=5, add=TRUE)
@
