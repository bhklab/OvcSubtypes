...
# Set options
knitr::opts_chunk$set(include=TRUE, results="hide", fig.width=8, fig.height=8, fig.path='figures/', fig.align='center', fig.show='hold',warning=FALSE, echo=FALSE, message=FALSE, cache=TRUE, error=FALSE)
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{prediction_strength_flowchart.png}
\end{figure}
\pagebreak
...
<<tothill_6_contingency_heatmap, fig.width=6, fig.height=5.5, out.width="0.6\\textwidth">>=
...
@
\vspace*{10pt}
<<tothill_5_contingency_heatmap, fig.width=5.5, fig.height=5.5, out.width="0.5\\textwidth">>=
