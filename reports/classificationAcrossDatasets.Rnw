...
concordant <- match(eset$Konecny, subtype.correspondances$Konecny) ==
  match(eset$Verhaak, subtype.correspondances$Verhaak) &
  match(eset$Verhaak, subtype.correspondances$Verhaak) ==
  match(eset$Helland, subtype.correspondances$Helland)
